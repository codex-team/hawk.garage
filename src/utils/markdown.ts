...
/**
 * A block is lexed no more once this many content blocks and characters follow it.
 * No distance is enough in general: a later line can still rewrite an earlier block
 * (https://spec.commonmark.org/0.31.2/#link-reference-definitions),
 * so `reparse` lexes the whole answer once the stream ends.
 */
 ...
 */
export async function createMarkdownLexer(): Promise<MarkdownLexer> {
